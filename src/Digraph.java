...
public class Digraph<V> {
    ...
    public static boolean hasPath ( graphNode n1 , graphNode n2,Digraph graph)
    {
    	n1.var = graphNode.State.visiting;
    	List<graphNode> temp = (List<graphNode>) graph.neighbors.get(n1);
    	for ( graphNode t: temp)
    	{
    		if (t.var == graphNode.State.unvisited)
    		{
    			t.var = graphNode.State.visiting;
    			if(t == n2)
    			{
    				return true;
    			}
    			if(hasPath(t,n2,graph))
    			{
    				return true;
    			}
    			
    		}
    		t.var = graphNode.State.visited;
    	}
    	return false;
    ...
    public static void main (String[] args) {
    	...
    	Digraph<graphNode<Integer,String>> graph = new Digraph<graphNode<Integer,String>>();
        graphNode<Integer,String> t1 = new graphNode<Integer, String>(1,"a");graphNode<Integer,String> t2 = new graphNode<Integer, String>(2,"b");
        graphNode<Integer,String> t3 = new graphNode<Integer, String>(3,"c");graphNode<Integer,String> t4 = new graphNode<Integer, String>(4,"d");
        graphNode<Integer,String> t5 = new graphNode<Integer, String>(5,"e");//graphNode<Integer,String> t2 = new graphNode<Integer, String>(2,"b");
;

        graph.add(t1, t2);
        graph.add(t2, t3);
        graph.add(t3,t4); graph.add(t4, t1);//graph.add(t3, t5);
        graph.add(t5, t1);
        if( hasPath(t1,t5,graph))
        {
